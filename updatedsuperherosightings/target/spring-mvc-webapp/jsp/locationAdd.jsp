<%-- 
    ...
    Created on : May 9, 2021, 2:20:17 PM
    Author     : greta
--%>
                ...
                <h2>Add Location</h2>
                    <sf:form class="form-horizontal" role="form" modelAttribute="location" action="addLocation" method="POST">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="text" class="form-control" path="locationName" placeholder="Location Name"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="text" class="form-control" path="locationDescription" placeholder="Description"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="text" class="form-control" path="locationStreet" placeholder="Street"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="text" class="form-control" path="locationCity" placeholder="City"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="text" class="form-control" path="locationState" placeholder="State"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="decimal" class="form-control" path="latitude" placeholder="Latitude"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="decimal" class="form-control" path="longitude" placeholder="Longitude"/>
