<%-- 
    Document   : items
    Created on : Feb 6, 2021, 4:18:24 PM
    Author     : greta
--%>
            ...
            <div class="col-md-3" id="right-side">
                ...
                <form class="form-horizontal" role="form" id="messages">
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="text" readonly class="form-control text-center" id="display"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-3 col-md-5">
                            <button type="button" id="button" class="btn btn-default">Make Purchase</button>
                        </div>
                    </div>
